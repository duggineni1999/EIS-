...
const AfterSales = () => {
  ...
  return (
    <div className='product'>
          ...
          <header className=" py-3 py-md-4 py-lg-5">
              <div className="container">
                  <p className=" ">Capabilities</p>
                  <h2 className="">After Sales & Warranty</h2>
              </div>
          </header>

          <section className="p2-image position-relative" style={{ backgroundImage: "url(Images/aftersalesbg.jpg)", height: '900px', backgroundSize: 'cover' }}>
              <div className="d-flex justify-content-center">
                  <div className="container position-absolute p-2 p-sm-3 p-lg-5" style={{ bottom: '0%', background: '#01813BD9' }}>
                      <p className="p2-description">We offer after-sales support and warranty services abiding by the contractual obligations with the customers. Our team will be upright in offering any kind of technical and logistics support to the customers.</p>
                  </div>
              </div>
              ...
              <div className=" mt-5">
                  <div className="row">
                      <div className="col-12 col-md-4 mb-3">
                          <div className="card text-center">
                              <div className=" section2-img">
                                  <img src="/Images/Group 13570.svg" alt="13570" className="mt-5 "/>
                              </div>
                              <div className="card-body">
                                  <div className="card-text">
                                      <p className="m-2 m-md-3 m-lg-4 text-center">
                      ...
                      <div className="col-12 col-md-4 mb-3">
                          <div className="card text-center" >
                              <div className=" section2-img">
                                  <img src="/Images/4394181 1.png" alt="4394181" className="mt-5  img-fluid" />
                              </div>
                              <div className="card-body">
                                  <div className="card-text">
                                      <p  className="m-2 m-md-3 m-lg-4 text-center">
                      ...
                      <div className="col-12 col-md-4 mb-3">
                          <div className="card text-center" >
                              <div className=" section2-img">
                                  <img src="/Images/Group 12693.svg" alt="12693" className="mt-5 img-fluid" />
                              </div>
                              <div className="card-body">
                                  <div className="card-text">
                                      <p  className="m-2 m-md-3 m-lg-4 text-center">
