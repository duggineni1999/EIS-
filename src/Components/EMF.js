...
function EMF() {
    ...
    return (
        <div className="emf">
            ...
            <section className=" py-3 py-md-4 py-lg-5" style={{ background: '#01813B' }} id="section_1">
            ...
            <section className=" position-relative" id="section_2" >
                <div className="">
                    <video
                        ...
                        controls={false}
                    >
                        <source src={emfv} type="video/mp4" />
                    </video>
                </div>
                <div className="d-flex justify-content-center">
                    <div className=" container position-absolute p-2 p-sm-3 p-lg-5  " style={{ bottom: '1%', background: '#01813BD9' }}>
                        <p className="section2-content text-center"> EIS Services refer to a comprehensive range of services provided by
                            ...
                            from design and prototyping to assembly, testing</p>
                    </div>
                </div>
