...
import VideoFile from './bannervideo new.mp4';
import Vedio1 from './DJI 0762.mp4';
...
const Home = () => {
    ...
    const CertificationCard = ({ imgSrc, title }) => (
      <div className="card mb-3 mb-lg-5 bg-transparent border-0">
          <div className="card-img-top">
              <img src={imgSrc} height="94.17px" width="160px" alt="" />
          </div>
    ...
    const NewsCard = ({ imgSrc, title }) => (
      <div className="col-12 col-md-6 col-lg-3">
          <div className="card border-0 bg-transparent">
              <img src={imgSrc} className="card-img rounded-0" height="255px" width="100%" style={{ filter: 'brightness(0.6)' }} alt="" />
              <div className="card-img-overlay content">
                  <h6 className="card-text shadow fw-medium text-white fs-5" style={{ textShadow: '0px 0px 5px #000000' }}>{title}</h6>
              </div>
          </div>
      </div>
  );
  ...
  return (
    <div>
      ...
      <section className="container-fluid p-0 position-relative" id="home_header">
        {/* <video src="Images/home.mp4" type="video/mp4" autoPlay muted loop playsInline style={{ width: '100%', height: '100%', objectFit: 'cover', zIndex: '-1', position: 'absolute', left: '0', bottom: '0', top: '0' }} /> */}
        ...
        <div className="container py-5" >
          <div className="row pt-5">
            <div className="col-12 col-lg-8 mb-5 ms-lg-5 py-5">
              <h6 className="mb-3 text-uppercase text-white-50">
              ...
              >
                A Trusted Electronic Manufacturing Services Company
              </h1>
              <div className="col-9 my-5">
                <p className="mb-4 text-white-50">
                  “Embedded IT Solutions (India) Pvt. Ltd., As A Recognized
                  Electronic Manufacturing Services Solutions From Low Volume
                  Needs To High End Markets...”
                </p>
                <div className="bg-black rectangle">
                  <p className="text-nowrap">
                    <span style={{ color: "#1AC664" }}>Get</span> to know us +
                  </p>
                </div>
              </div>
            </div>
            <div className="col-12 col-lg-4 py-5">
              <div
                ...
                style={{ bottom: "0", right: "0", left: "60%" }}
              >
                <img
                  className="img-fluid"
                  src="/Images/Group 3608.png"
                  alt=""
                />
              </div>
            </div>
      ...
      >
        <div className="row">
          <div className="col-12 col-lg-8 pt-5">
            <img
              ...
              className="img-fluid ps-md-5 w-75 ps-0 pt-5 position-absolute"
              style={{ top: "90px" }}
              alt=""
            />
          </div>
        ...
        <div className="container ps-lg-5" style={{ paddingTop: "100px" }}>
          <div className="py-5">
            <h6 className="mb-5 ps-lg-3">ABOUT COMPANY</h6>
            <p className="ps-lg-4">
              Embedded IT Solutions (India) Pvt. Ltd., provide services that
              include new product prototyping with FMEA, simple to high
              technology PCBA manufacturing capability and build-to-order
              systems assembly. Our products are manufactured by high-end SMT
              technology machines to meet global quality standards and are
              supported by a dedicated after market services and repairs.
            </p>
          </div>
        </div>

        <div className="container pb-5" id="sub_row">
          <div className="row ps-lg-5 pb-5 mb-5">
            <div className="col-12 col-lg-6">
              <iframe
                width="100%"
                height="315"
                src="https://www.youtube.com/embed/qV4Q2Su987A?si=dxfCzeq2IAgN0XSF"
            ...
            <div className="col-12 col-lg-5 ">
              <div className="d-flex flex-row justify-content-lg-center">
                <ul className="d-flex flex-column text-white mb-5 pb-5">
                  <li>New Product Introduction</li>
                  <li>PCB Assembly & Box Build</li>
                  <li>Flexible volume High Mix Manufacturing</li>
                  <li>Electronic Manufacturing</li>
                  <li>Product Testing</li>
                  <li>After-Sales Support & Warranty Services</li>
                </ul>
              </div>
            </div>

            <div
              className="bg-black rectangle position-absolute"
              style={{ bottom: "10%", right: "30%" }}
            >
              <p className="text-nowrap">
                <span style={{ color: "#FFFFFF" }}>Get</span> to know us +
              </p>
            </div>
          </div>
        </div>
      ...
      <section
        ...
        id="home_section_3"
        style={{ zIndex: "5",background: "rgba(223, 220, 220, 0.699)" }}
      >
        <video
          src={Vedio1}
          autoPlay
        ...
        <div style={{ zIndex: "5",background: "rgba(223, 220, 220, 0.699)" }}>
        <div className="container py-5" >
          <div className="row gap-lg-4 py-5">
            <div className="col-12 col-lg-5">
              <div className="head">
                ...
                <p className="ps-lg-3">
                  EIS's array of services encompasses contract manufacturing,
                  cutting-edge new product prototyping supported by FMEA
                  analysis, mid-range volume production, PCBA manufacturing with
                  POP capabilities, as well as complete turnkey solutions for
                  build-to-order (BTO) and configure-to-order (CTO) systems
                  assembly.
                </p>
              </div>
            </div>

            <div className="col-12 col-lg-2" style={{ paddingTop: "100px" }}>
              <div>
                <img
            ...
            <div className="col-12 col-lg-4" style={{ paddingTop: "130px" }}>
              <div className="sub_head">
                <h1>NPI / Prototyping</h1>
                <p>
                  EIS is a leading company in the production of prototypes and
                  industrialization. Our NPI project Team can act as your
                  partner throughout the entire process – from concept to
                  finished product.
                </p>
                <ul>
          ...
          <div className="union py-5">
            <img
              src="Images/Union_2.png"
          ...
          <div className="scroll">
            <img
              ...
              style={{ bottom: "50px", right: "50px", height: "170px" }}
              alt=""
            />
          </div>
        </div>
      ...
      <section
        className="container-fluid p-2 p-sm-3 p-md-4 p-lg-5 position-relative"
        style={{ backgroundColor: "#01813B" }}
        id="home_section_5"
      >
        <div className="container py-5">
          <div className="head">
          ...
          <div className="container pt-5">
            <div className="row">
              ...
              <div className="col-12 col-lg-6">
                <ul className="two_ul">
                  <li>
                    Build To Order (BTO), Configure To Order (CTO) systems
                  </li>
            ...
            <div className="pt-5">
              <div className="row">
                <div className="col-12 col-lg-4 mb-4 mb-lg-2">
                  <img
                    src="Images/IMG_20190326_125922 1.png"
      ...
      <section
        ...
        style={{
          ...
          backgroundImage: "url('Images/section-6_bg.png')",
        }}
        id="home_section_6"
      >
          ...
          <div className="row pt-5 gap-5">
            <div className="col-12 col-lg-4 position-relative">
              <div className="head py-5">
                ...
                <p className="ms-4 pt-3">
                  Recognized Electronic Manufacturing Service (EMS) provider
                  with state of the art facilities.
                </p>
              </div>
              <div className="bg-black rectangle">
                <p className="text-nowrap ms-4 mt-3">
                  <span style={{ color: "#00923F" }}>View </span>
                  <span style={{ color: "#1AC664" }}>
                    gallery <span className="ms-3 text-white">+</span>
                  </span>
                </p>
              </div>
            </div>
            <div className="col-12 col-lg-3 ps-4 pt-5">
              <div className="image1 mb-5">
                <img
                  src="Images/IMG_20180820_143020 1.png"
                  className="img-fluid w-100"
                  height="197px"
                  alt=""
                />
              ...
              <div className="image2 mb-5">
                <img
                  src="Images/IMG_20180820_143027 1.png"
                  className="img-fluid w-100"
                  height="197px"
                  alt=""
                />
      ...
      <section
        ...
        style={{ background: "rgba(223, 220, 220, 0.699)" }}
        id="section_7"
      >
        <video
          ref={videoRef}
          ...
          <div className="row ps-lg-5 mt-5 pb-lg-5">
            <div className="col-12 col-sm-12 col-md-12 col-lg-6">
              <p className="des-heading">
                Our boards are being used in sophisticated products catering for
                various commercial and industrial segments.
              </p>
              <video
                ref={videoRef}
                  ...
                  <div className="col-12 col-md-6 section7-svg">
                    <div className="d-flex flex-column gap-4   ">
                      <div className="d-flex mb-3">
                        ...
                        >
                          <path
                            d="M23.7984 34.671C24.673 34.671 25.3819 33.962 25.3819 33.0875C25.3819 32.2129 24.673 31.5039 23.7984 31.5039C22.9238 31.5039 22.2148 32.2129 22.2148 33.0875C22.2148 33.962 22.9238 34.671 23.7984 34.671Z"
                            fill="#01813B"
                            stroke="#01813B"
                            stroke-width="5"
                          ...
                          />
                          <path
                            d="M44.3831 12.5013C39.0372 6.75078 31.6414 3.33733 23.797 3C15.9527 3.33733 8.55689 6.75078 3.21094 12.5013"
                            stroke="#01813B"
                            stroke-width="5"
                            stroke-linecap="round"
                            stroke-linejoin="round"
                          />
                          <path
                            d="M38.0488 18.8361C34.3216 14.9247 29.1978 12.6474 23.7968 12.502C18.3959 12.6474 13.2721 14.9247 9.54492 18.8361"
                            stroke="#01813B"
                            stroke-width="5"
                            stroke-linecap="round"
                            stroke-linejoin="round"
                          />
                          <path
                            d="M31.7163 25.1689L31.6371 25.248C30.6078 24.2186 29.3858 23.402 28.0408 22.8449C26.6959 22.2877 25.2544 22.001 23.7986 22.001C22.3428 22.001 20.9013 22.2877 19.5564 22.8449C18.2114 23.402 16.9894 24.2186 15.96 25.248L15.8809 25.1689"
                            stroke="#01813B"
                            stroke-width="5"
                            stroke-linecap="round"
                            stroke-linejoin="round"
                        ...
                        <h6 className="icon-content mt-2 ms-3">
                          Wi-Fi modules
                        </h6>
                      </div>
                      <div className="d-flex mb-3">
                      ...
                      <div className="d-flex mb-3">
                        ...
                        >
                          <path
                            d="M34.6584 0.683594H14.216C12.7019 0.683594 11.4629 1.92255 11.4629 3.43673V21.0566H13.1838V3.43673C13.1838 2.88597 13.6656 2.40438 14.2161 2.40438H18.4146L20.4107 4.33127H28.3949L30.391 2.40404H34.5895C35.1402 2.40404 35.6218 2.88592 35.6218 3.4364V40.6043C35.6218 41.1551 35.14 41.6367 34.5895 41.6367L18.6211 41.637L18.0703 42.1878L17.038 41.637H14.2848L13.7341 43.289C13.8718 43.289 14.0093 43.3579 14.1471 43.3579H34.5894C36.1036 43.3579 37.3425 42.1189 37.3425 40.6048V3.43683C37.4114 1.92265 36.1724 0.683688 34.6582 0.683688L34.6584 0.683594Z"
                            fill="#01813B"
                          />
                          <path
                            d="M26.6052 38.0577C26.6052 39.2359 25.6499 40.1912 24.4714 40.1912C23.2931 40.1912 22.3379 39.2359 22.3379 38.0577C22.3379 36.879 23.2932 35.9238 24.4714 35.9238C25.65 35.9238 26.6052 36.8791 26.6052 38.0577Z"
                            fill="#01813B"
                          />
                          <path
                            d="M16.7617 9.90625H32.1793V14.8618H16.7617V9.90625Z"
                            fill="#01813B"
                          />
                          <path
                            d="M16.7617 18.3037H32.1793V23.2593H16.7617V18.3037Z"
                            fill="#01813B"
                          />
                          <path
                            d="M19.7207 28.4906C19.8585 28.8347 20.0648 29.1788 20.2026 29.5918L22.9557 30.4867V31.6568H32.11V26.7012H20.6849L19.7207 28.4906Z"
                            fill="#01813B"
                          />
                          <path
                            d="M22.2687 34.1343V30.9681L19.6533 30.1421C19.447 29.5914 19.2403 29.0409 18.9651 28.4901L20.204 26.0122L17.9327 23.8098L15.4548 25.0487C14.904 24.7735 14.3536 24.5669 13.8028 24.3605L12.9768 21.7451H9.81064L8.98466 24.3605C8.43389 24.4983 7.88343 24.7735 7.33265 25.0487L4.85474 23.8098L2.58342 26.0122L3.82238 28.4901C3.54716 28.972 3.3405 29.5225 3.13417 30.1421L0.65625 30.9681V34.1343L3.27165 34.9603C3.40942 35.5111 3.68465 36.0615 3.95987 36.6123L2.72091 39.0902L4.99222 41.3615L7.47014 40.1226C7.95202 40.3978 8.50249 40.6044 9.12214 40.8108L9.94813 43.4262H13.1143L13.9403 40.8108C14.4911 40.6044 15.0415 40.3978 15.5923 40.1226L18.0702 41.3615L20.3415 39.0902L19.1026 36.6123C19.3778 36.0615 19.5844 35.5111 19.7908 34.9603L22.2687 34.1343ZM11.4621 36.1993C9.46598 36.1993 7.81406 34.5473 7.81406 32.5513C7.81406 30.5552 9.46606 28.9032 11.4621 28.9032C13.4582 28.9032 15.1101 30.5552 15.1101 32.5513C15.179 34.5473 13.527 36.1993 11.4621 36.1993Z"
                            fill="#01813B"
                          />
                        </svg>
                        <h6 className="icon-content mt-2 ms-3">
                  ...
                  <div className="col-12 col-md-6 mt-2">
                    <div className="d-flex flex-column gap-4 section7-svg">
                      ...
                      <div className="d-flex ">
                        ...
                        >
                          <path
                            d="M23.6623 16.08C23.6623 15.4818 23.1774 14.9968 22.5792 14.9968C21.981 14.9968 21.4961 15.4818 21.4961 16.08C21.4961 16.6782 21.981 17.1631 22.5792 17.1631C23.1774 17.1631 23.6623 16.6782 23.6623 16.08Z"
                            fill="#01813B"
                            stroke="#01813B"
                            stroke-width="4"
                            stroke-linecap="round"
                          ...
                          />
                          <path
                            d="M8.49873 1.99995C4.56548 5.6565 2.23073 10.7151 2 16.0805C2.23073 21.446 4.56548 26.5046 8.49873 30.1611"
                            stroke="#01813B"
                            stroke-width="4"
                            stroke-linecap="round"
                            stroke-linejoin="round"
                          />
                          <path
                            d="M12.8305 6.3329C10.1552 8.88223 8.59756 12.3868 8.49805 16.081C8.59756 19.7752 10.1552 23.2798 12.8305 25.8291"
                            stroke="#01813B"
                            stroke-width="4"
                            stroke-linecap="round"
                            stroke-linejoin="round"
                          />
                          <path
                            d="M17.1629 10.6649L17.217 10.719C16.5129 11.4231 15.9544 12.2589 15.5733 13.1789C15.1922 14.0988 14.9961 15.0848 14.9961 16.0805C14.9961 17.0762 15.1922 18.0622 15.5733 18.9821C15.9544 19.902 16.5129 20.7379 17.217 21.4419L17.1629 21.4961"
                            stroke="#01813B"
                            stroke-width="4"
                            stroke-linecap="round"
                            stroke-linejoin="round"
                          />
                          <path
                            d="M21.5173 16.0812C21.5173 16.6794 22.0023 17.1643 22.6005 17.1643C23.1987 17.1643 23.6836 16.6794 23.6836 16.0812C23.6836 15.483 23.1987 14.998 22.6005 14.998C22.0023 14.998 21.5173 15.483 21.5173 16.0812Z"
                            fill="#01813B"
                            stroke="#01813B"
                            stroke-width="4"
                            stroke-linecap="round"
                          ...
                          />
                          <path
                            d="M36.681 30.1612C40.6142 26.5046 42.949 21.446 43.1797 16.0806C42.949 10.7152 40.6142 5.65655 36.681 2"
                            stroke="#01813B"
                            stroke-width="4"
                            stroke-linecap="round"
                            stroke-linejoin="round"
                          />
                          <path
                            d="M32.3472 25.8282C35.0226 23.2789 36.5802 19.7743 36.6797 16.0801C36.5802 12.386 35.0226 8.88136 32.3472 6.33203"
                            stroke="#01813B"
                            stroke-width="4"
                            stroke-linecap="round"
                            stroke-linejoin="round"
                          />
                          <path
                            d="M28.0168 21.4963L27.9626 21.4421C28.6668 20.7381 29.2253 19.9022 29.6064 18.9823C29.9875 18.0624 30.1836 17.0764 30.1836 16.0807C30.1836 15.0849 29.9875 14.0989 29.6064 13.179C29.2253 12.2591 28.6668 11.4232 27.9626 10.7192L28.0168 10.665"
                            stroke="#01813B"
                            stroke-width="4"
                            stroke-linecap="round"
                            stroke-linejoin="round"
                        ...
                        <h6 className="icon-content  ms-3">
      ...
      >
        <div className="container py-5">
          <div className="head">
            ...
            <h5 className="pt-4 ps-lg-5">Our Recognition & Awards</h5>
          </div>

          <div className="container ms-lg-5 mt-5 py-5" id="logo">
            <div className="row ">
              <div className="col-12 col-md-3">
                <CertificationCard
                  imgSrc="Images/GIC-ISO2015-300x216 3.png"
                  title="Certified for ISO 9001:2015 Quality Management Systems"
                />
                <CertificationCard
                  imgSrc="Images/GIC-ISO2015-300x216 2.png"
                  title="Certified for 14001:2015 Environmental Management Systems"
                />
              </div>

              <div className="col-12 col-md-3">
                <CertificationCard
                  imgSrc="Images/iqas.png"
                  title="Certified for IATF 16949:2016 International Automotive Task Force"
                />
                <CertificationCard
                  imgSrc="Images/GIC-ISO2015-300x216 7.png"
                  title="Certified for 45001:2018 health and safety Systems"
                />
              </div>

              <div className="col-12 col-md-3">
                <CertificationCard
                  imgSrc="Images/GIC-ISO2015-300x216 9.png"
                  title="Compliance with ANSI / ESD 520.20-2021 Requirements Standards"
                />
                <CertificationCard
                  imgSrc="Images/1 1.png"
                  title="Certified for ISO / IEC 27002-2013"
                />
              </div>

              <div className="col-12 col-md-3">
                <CertificationCard
                  imgSrc="Images/GIC-ISO2015-300x216 4.png"
                  title="Certified for Responsible Business Alliance"
                />
              </div>
            </div>
          </div>
